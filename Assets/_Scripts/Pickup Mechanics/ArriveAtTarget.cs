...
public class ArriveAtTarget : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        _wagonContents = _cartTargetPoint.GetComponentInChildren<WagonService>(); // Returns NPC reference in wagon
        ...
        if (_wagonContents.zonedDeliveriesToggle == true && _wagonContents && _wagonContents.destination == gameObject)
        {
            AudioManager.Instance.PlaySFX("Out");
